const translations = {
  es: {
    ...
    footer_copy: 'LXBE · Presskit Oficial',
  ...
  en: {
    ...
    footer_copy: 'LXBE · Official Presskit',
...
const applyTranslations = (lang) => {
  ...
  if (footerCopy) {
    footerCopy.textContent = `© ${year} ${dict.footer_copy}`;
  }
...
<body>
  <div class="sheet">
    ...
    <p class="meta">Instagram: ${INSTAGRAM_PROFILE_URL} · SoundCloud: ${SOUNDCLOUD_PROFILE_URL}</p>
  </div>
</body>
</html>`;
